    ...
    return (
        <>
            <ScrollView
                ...
                onLayout={(e) => setScrollViewHeight(e.nativeEvent.layout.height)} // Altura de la pantalla visible
                onContentSizeChange={(w, h) => setContentHeight(h)} // Altura de todo el contenido
                onScroll={handleScroll} // Escuchar el movimiento
                scrollEventThrottle={16} // Importante para que onScroll se dispare fluido
            >
                <Hydra />
                <View style={styles.text}>
                    <Text style={styles.title}>{t("ask.age")}</Text>
                </View>
