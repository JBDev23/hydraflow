...
import type { CatalogItem, Theme } from '../../types';
    ...
    try {
      ...
      if (response) {
        ...
        await updateUserProfile({
          ...
          stats: {
            ...userProfile!.stats,
            dropsBalance: response.dropsBalance ?? userProfile!.stats.dropsBalance,
            skinsCount: response.skinsCount ?? userProfile!.stats.skinsCount,
          },
        });
      }
    } catch (error) {
